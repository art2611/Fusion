            ...
            for i in [w for w in range(10)]:
                if i not in appeared:
                    if modal == "VtoT":
                        ...
                        sec_label_slice_gallery.append(file_label_visible[k * 10])
            print(f"sec_image_slice_gallery len : {len(sec_image_slice_gallery)}")
            print(f"sec_image_slice_gallery_2 len : {len(sec_image_slice_gallery)}")
            print(f"sec_label_slice_gallery len : {len(sec_label_slice_gallery)}")
        if modal == "BtoB" :
